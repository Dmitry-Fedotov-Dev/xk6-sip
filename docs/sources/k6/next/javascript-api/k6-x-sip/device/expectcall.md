...
Waits for an incoming call that matches the expected caller and number, and claims it. The call keeps ringing until the script [accepts](../../call/accept/) or [rejects](../../call/reject/) it.
...
| --- | --- | --- | --- |
| options.caller | [Device](../) or string | any caller | Expected caller. A Device, or a literal number to compare with the caller number. |
...
| Type | Description |
| --- | --- |
| [Call](../../call/) or `false` | The incoming call leg, or `false` if no matching call arrived in time. |
